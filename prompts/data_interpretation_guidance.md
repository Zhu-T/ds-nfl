...
- **Draft / preseason:** If `stats_context` is present (or seasons are older than the fantasy year), treat those lines as prior-year production only — the upcoming regular season has not started. Do not invent current-year stats; rookies may have empty history.
